 ...
 */
final class Version20190401062450 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE requested (id INT AUTO_INCREMENT NOT NULL, requested_for_id INT NOT NULL, requested_by_id INT NOT NULL, requested_mother_response VARCHAR(255) DEFAULT NULL, requested_at DATETIME DEFAULT NULL, requested_token VARCHAR(255) DEFAULT NULL, requested_accepted TINYINT(1) DEFAULT NULL, requested_refused TINYINT(1) DEFAULT NULL, requested_banned TINYINT(1) DEFAULT NULL, INDEX IDX_98521BAF37DD3AF1 (requested_for_id), INDEX IDX_98521BAF4DA1E751 (requested_by_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE role (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE role_user (role_id INT NOT NULL, user_id INT NOT NULL, INDEX IDX_332CA4DDD60322AC (role_id), INDEX IDX_332CA4DDA76ED395 (user_id), PRIMARY KEY(role_id, user_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE serial_number (id INT AUTO_INCREMENT NOT NULL, mother_id INT NOT NULL, serial_wristlet VARCHAR(255) NOT NULL, wristlet_title VARCHAR(255) NOT NULL, active_serial TINYINT(1) DEFAULT NULL, attributed_to TINYINT(1) DEFAULT NULL, INDEX IDX_D948EE2B78A354D (mother_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, adress VARCHAR(255) NOT NULL, postal_code VARCHAR(10) NOT NULL, city VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, pswd VARCHAR(255) NOT NULL, password_requested_at DATETIME DEFAULT NULL, token VARCHAR(255) DEFAULT NULL, active TINYINT(1) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE weared DROP FOREIGN KEY FK_708D721C862CC228');
