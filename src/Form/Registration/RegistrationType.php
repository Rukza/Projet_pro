...
//Form to registratre a new user
...
class RegistrationType extends ApplicationType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('checkConsent',CheckboxType::class,$this->getConfiguration("En soumettant ce formulaire, j'accepte que les informations saisies soient exploitées dans le cadre de la demande d'inscription sur le site et de cette application.", " ", array()))
        ;
    }
